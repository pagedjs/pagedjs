...
class RunningHeaders extends Handler {
	...
	constructor(chunker, polisher, caller) {
		 ...
		 * @type {Object<string, {identifier: string, value: string, selector: string, first?: Element}>}
		 */
		this.runningSelectors = {};

		/**
		 * Stores element() CSS content references keyed by selector string.
		 * @type {Object<string, {func: string, args: Array<string>, value: string, style: string, selector: string, fullSelector: string}>}
		 */
		this.elements = {};
	}
